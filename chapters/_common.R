...
status <- function(type) {
  ...
  cat(paste0(
    ...
    class,
    " \n",
    "You are reading the work-in-progress first edition of Notes for Deep Learning. ",
    "This chapter ",
    status,
    ". ",
    "You can find the complete first edition at <https://lulab-sysu.github.io/dl_notes>.\n",
    ":::\n",
    "::::\n"
  ))
}
